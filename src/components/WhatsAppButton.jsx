        ...
        <div className="wa-chat-card" role="dialog" aria-modal="true">
          ...
          <div className="wa-card-header">
            ...
            <div className="wa-header-info">
              <h4 className="wa-header-title">SD Majesta Concierge Desk</h4>
          ...
          <div className="wa-card-body">
            <div className="wa-bubble-intro">
              Welcome to <strong>SD Majesta</strong>. Select what you would like assistance with, and we will prepare your direct message to our VIP desk:
            </div>
              ...
              {PRESET_OPTIONS.map((opt) => (
                ...
                >
                  <div className="wa-option-pill__text">
                    <span className="wa-option-pill__title">{opt.label}</span>
            ...
            <div className="wa-preview-box">
              <div className="wa-preview-header">
                <span className="wa-preview-title">Auto Generated Message</span>
                <span className="wa-preview-status">Ready to Send</span>
              </div>
              <textarea
          ...
          <div className="wa-card-footer">
            ...
            <div className="wa-footer-note">
              Encrypted 1-on-1 VIP concierge with SD Majesta advisors
            </div>
          </div>
        </div>
      )}
